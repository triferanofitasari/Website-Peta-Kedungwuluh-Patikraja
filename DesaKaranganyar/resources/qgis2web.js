...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [12153863.863060, -833788.011447, 12159404.703772, -831165.691669], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([12153863.863060, -833788.011447, 12159404.703772, -831165.691669], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA DESA KARANGANYAR</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (103 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menampilkan batas Desa Karanganyar,Kecamatan Patikraja,Kabupaten Banyumas,Provinsi Jawa Tengah';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_KantorBalaiDesaKaranganyar_2,
    colName: 'Nama',
    zoom: 10,
    collapsed: true,
    map: map,
