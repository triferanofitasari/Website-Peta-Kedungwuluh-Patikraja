...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [12150487.207483, -837371.975008, 12159642.332090, -832978.877469], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([12150487.207483, -837371.975008, 12159642.332090, -832978.877469], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA DESA KARANGENDEP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (103 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menampilkan batas Desa Karangendep,Kecamatan Patikraja,Kabupaten Banyumas,Provinsi Jawa Tengah';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_BalaiDesaKarangendep_2,
    colName: 'Nama',
    zoom: 10,
    collapsed: true,
    map: map,
