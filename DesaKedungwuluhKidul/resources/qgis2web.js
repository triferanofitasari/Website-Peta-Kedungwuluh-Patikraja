...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [12154582.851621, -835183.780998, 12158981.262183, -833073.243515], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([12154582.851621, -835183.780998, 12158981.262183, -833073.243515], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA DESA KEDUNGWULUH KIDUL</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (112 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menampilkan batas Desa Kedungwuluh Kidul, Kecamatan Patikraja, Kabupaten Banyumas, Provinsi Jawa Tengah';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_BalaiDesaKedungwuluhKidul_2,
    colName: 'Nama',
    zoom: 10,
    collapsed: true,
    map: map,
